  ...
  return (
    <div className='flex flex-col items-center justify-center bg-white px-4'>
        ...
        <div className='bg-white rounded-2xl shadow-lg p-10 flex flex-col items-center space-y-4'>
            <input type="file" id="upload2" hidden accept='image/*' onChange={()=>{removeBg(e.target.files[0])}} />
            <label htmlFor="upload2" className='bg-indigo-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full'>
                Upload Image
